 ...
 The purpose of this assignment is to showcase knowledge of object-oriented programming.
 ...
 The application should be written in php. The candidate should not use the UI or use the database.

				Task

Create application TRADE CHAIN.TRADE CHAIN can have multiple stores.
...
Each store should have a record of products sold in the selected period.

				Test

Make a test that should contain one store of each type, with a minimum of 2 products.
...
Create a report of the sold products for each store for today.

				Bonus
Every sale of each product should be logged in the format: 
type of store,  type of product, product price, before-sale supplies, after-sales supplies, time of sale.
